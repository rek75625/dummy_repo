...
class ServicesAccordingly extends StatelessWidget {
  final ServiceModel service;
  final bool expanded;
  final VoidCallback onTap;
  final int index;

  const ServicesAccordingly({
    super.key,
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: expanded ? yellow : Colors.white.withValues(alpha: 0.12),
              width: 1,
            ),
          ...
          child: Column(
            children: [
              ...
              AnimatedSize(
                ...
                child: expanded
                    ? Padding(
                        padding: EdgeInsets.only(top: mobile ? 18 : 22),
